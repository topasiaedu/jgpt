...
export const CONTENT_ASSET_PLANNER_PACK: ModulePack = {
  ...
  systemOverlay: [
    ...
    "认知 = 是谁 (market knows who you are).",
    "信任 = 靠谱 (market knows you are reliable).",
    "成交 = 怎么买 (market knows how to buy).",
    "",
    ...
    "",
    "### Output shape",
    "1. Restate the four defs once, then priority mix for their stage across 曝光 / 认知 / 信任 / 成交.",
    "2. Day-by-slot: title/angle, one asset type (with the short def), format hint.",
