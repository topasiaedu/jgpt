...
export const PACK_CHAT_OPENERS_ZH: Record<string, string> = {
  ...
  "soundbite-one-liner":
    "我会按 Memory Hook / 记忆钩子写出能复述的金句（一句话，再补场景与结果）。你希望别人记住你做事方式的哪一个信念？",
  "content-asset-planner":
    "我会按四种内容资产（曝光 / 认知 / 信任 / 成交）给帖子归类排期，不管堆叠漏斗。你现在主要是没被看见、在建信任，还是在成交？",
  "content-asset-stack":
    "我会按 Content Asset Stack / 内容资产堆叠（看见 → 记住 → 相信 → 询问 → 成交）看这条内容把人推到哪一步。把草稿或选题贴过来，并说给谁看。",
  "direction-fixer":
  ...
  "comment-reply-three-lines":
    "我会按评论回应三句法起草回复：接住、澄清、拉回主轴。把评论贴过来。",
  "criticism-armor":
    "我会跑 B.R.E.A.K Shield / 评论护盾，把批评变成判断而不是情绪。你怕什么批评，或已经收到什么？",
  "bianhao-coach":
